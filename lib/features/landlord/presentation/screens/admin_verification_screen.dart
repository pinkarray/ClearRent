...
class _AdminVerificationScreenState extends State<AdminVerificationScreen>
  ...
  // Track currently processing verification ids to prevent double actions
  ...
  // Filter by user type
  String _selectedFilter = 'all'; // all, landlord, tenant, agent
  ...
  List<PendingVerification> get _filteredVerifications {
    ...
    return _allVerifications
        .where((v) => v.userType == _selectedFilter)
        .toList();
  }
  ...
  Future<void> _approveVerification(PendingVerification verification) async {
      ...
      builder:
          (ctx) => AlertDialog(
            ...
            content: Column(
              ...
              children: [
                Text(
                  'Are you sure you want to approve ${verification.fullName}?',
                ),
    ...
    try {
      ...
      if (success) {
        _showMessage(
          '${verification.fullName} has been verified!',
          isError: false,
        );
      ...
      builder:
          (ctx) => AlertDialog(
            ...
            content: Column(
              ...
              children: [
                Text(
                  'Why is ${verification.fullName}\'s verification being rejected?',
                ),
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'They will be able to re-submit with new documents.',
                          style: AppTextStyles.bodySmall.copyWith(
                            color: AppColors.warning,
                          ),
                        ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Container(
                ...
                child: Text(
                  verification.userType.toUpperCase(),
          ...
          // Show documents based on user type
          ..._buildDocumentRows(),

          // Guarantor info for agents
          if (verification.userType == 'agent' &&
              verification.guarantorName != null) ...[
            const SizedBox(height: 16),
            _buildGuarantorInfo(),
          ],
      ...
      case 'tenant':
        rows.add(
          _DocumentRow(
            ...
            onTap:
                () => onOpenDocument(verification.documents.proofOfIncomeUrl),
          ),
        );
        break;
      case 'agent':
        rows.add(
          _DocumentRow(
            ...
            onTap:
                () => onOpenDocument(verification.documents.proofOfAddressUrl),
          ),
        );
        rows.add(const SizedBox(height: 8));
        rows.add(
        ...
        if (verification.documents.experienceProofUrl != null) {
          ...
          rows.add(
            _DocumentRow(
              ...
              onTap:
                  () =>
                      onOpenDocument(verification.documents.experienceProofUrl),
            ),
          );
        }
        break;
